...
# Complexidade de Tempo do Algoritmo Select Sort (Ordenacao
# Por Selecao). 
#
# Este programa GnuPlot seta uma janela grafica e le varios
# arquivos de dados.
# ----------------------------------------------------------
set title "Tempo de Execução - Selection Sort"
#
...
plot \
	"reports/Select-sort-rand.dat" title "Randomicos" w linespoints,\
        "reports/Select-sort-ord.dat" title "Ordenados" w linespoints, \
        "reports/Select-sort-inv.dat" title "Invertidos" w linespoints
