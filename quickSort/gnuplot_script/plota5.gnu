...
# Complexidade de Tempo do Algoritmo QuickSort
#
# Este programa GnuPlot seta uma janela grafica e le varios
# arquivos de dados.
# ----------------------------------------------------------
set title "Tempo de Execução - Quick Sort"
#
...
plot \
	"reports/Quick-sort-rand.dat" title "Randomicos" w linespoints,\
        "reports/Quick-sort-ord.dat" title "Ordenados" w linespoints, \
        "reports/Quick-sort-inv.dat" title "Invertidos" w linespoints
