...
# Complexidade de Tempo do Algoritmo Insertion Sort (Ordenacao
# Por Inserção). 
#
# Este programa GnuPlot seta uma janela grafica e le varios
# arquivos de dados.
# ----------------------------------------------------------
set title "Tempo de Execução - Insertion Sort"
#
...
plot \
	"reports/Insert-sort-rand.dat" title "Randomicos" w linespoints,\
        "reports/Insert-sort-ord.dat" title "Ordenados" w linespoints, \
        "reports/Insert-sort-inv.dat" title "Invertidos" w linespoints
