...
plot \
	"reports/Bubble-sort-rand.dat" title "Randomicos" w linespoints, \
        "reports/Bubble-sort-ord.dat" title "Ordenados" w linespoints, \
        "reports/Bubble-sort-inv.dat" title "Invertidos" w linespoints
